...
public class PersonTests
{
    ...
    public void Test_GetByAgeAscending_SortsPeopleByAge()
    {
        ...
        {
            new Person() { Name = "Cathrin", Id = "A002", Age = 25 },
            new Person() { Name = "Alice", Id = "A001", Age = 35 },
            new Person() { Name = "Bob", Id = "B002", Age = 20 },
        };
        string expectedOutput =
            $"Bob with ID: B002 is 20 years old.{Environment.NewLine}" +
            $"Cathrin with ID: A002 is 25 years old.{Environment.NewLine}" +
